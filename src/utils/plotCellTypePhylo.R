plotCellTypePhylo2 <- function(tree){
  ...
  graph=graph_from_data_frame(d=edge_matrix, directed = FALSE)
...
plotCellTypePhylo = function(x, type = "phylogram", use.edge.length = TRUE, node.pos = NULL, 
