...
## Revisiting the co-evolution analysis
...
ScatterPlot(ws.df, 
  ...
  coord_cartesian(xlim = c(15,46), ylim = c(15, 67))+
  scale_y_continuous(breaks = seq(15, 60, length.out = 4))+
  scale_x_continuous(breaks = seq(15, 45, length.out = 3))+
  theme_cowplot() + 
  ArialFont()+
  NoLegend() 
```
...
```{r, fig.height=4, fig.width=12}
# Highly significant association that could not be explained by sampling
...
# Simpson index
ScatterPlot(ws.df, x = 'RGC.simpson', y = 'AC.simpson', lm = T, r_pval = T, labels = 'species', max.overlaps = 100, 
            xlab = 'RGC Simpson index', ylab = 'AC Simpson index', fill = 'species', pt.size = 2) + 
  scale_fill_manual(values = lighten(species_palette3, 0.3)) + 
  this_theme() + 
  NoLegend()  | 
  ScatterPlot(ws.df, x = 'BC.simpson', y = 'AC.simpson', lm = T, r_pval = T, labels = 'species', max.overlaps = 100, 
              xlab = 'BC Simpson index', ylab = 'AC Simpson index', fill = 'species', pt.size = 2) + 
  scale_fill_manual(values = lighten(species_palette3, 0.3)) + 
  this_theme() + 
  NoLegend()  | 
  ScatterPlot(ws.df, x = 'BC.simpson', y = 'RGC.simpson', lm = T, r_pval = T, labels = 'species', max.overlaps = 100, 
...
# ScatterPlot(ws.df, x = 'AC.cells', y = 'RGC.cells', lm = T, r_pval = T, labels = 'species', max.overlaps = 100)
...
ScatterPlot(ws.df, x = 'AC.cells', y = 'AC.clusters', lm = T, r_pval = T, 
            xlab = '# of AC cells', ylab = '# of AC clusters',
            labels = 'species', max.overlaps = 100, logX = TRUE, fill = 'species', pt.size = 2) + 
  scale_fill_manual(values = lighten(species_palette3, 0.3)) + 
  theme_cowplot() + 
  NoLegend() | 
  ScatterPlot(ws.df, x = 'RGC.cells', y = 'RGC.clusters', lm = T, r_pval = T, 
              xlab = '# of RGC cells', ylab = '# of RGC clusters',
              labels = 'species', max.overlaps = 100, logX = TRUE, fill = 'species', pt.size = 2)+ 
  scale_fill_manual(values = lighten(species_palette3, 0.3)) + 
  theme_cowplot() + 
  NoLegend() | 
  ScatterPlot(ws.df, x = 'BC.cells', y = 'BC.clusters', lm = T, r_pval = T, 
              xlab = '# of BC cells', ylab = '# of BC clusters',
              labels = 'species', max.overlaps = 100, logX = TRUE, fill = 'species', pt.size = 2)+ 
  scale_fill_manual(values = lighten(species_palette3, 0.3)) + 
  theme_cowplot() + 
  NoLegend() 
